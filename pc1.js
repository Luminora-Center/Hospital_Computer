...
const cctvcam15 = document.getElementById("cctvcam15");
const closecctv = document.getElementById("closecctv");
const Next_camera_cctv15 = document.getElementById("Next_camera_cctv15");
const Back_camera_cctv15 = document.getElementById("Back_camera_cctv15");
const Next_camera_cctv28 = document.getElementById("Next_camera_cctv28");
const Back_camera_cctv28 = document.getElementById("Back_camera_cctv28");
const Next_camera_cctv37 = document.getElementById("Next_camera_cctv37");
const Back_camera_cctv37 = document.getElementById("Back_camera_cctv37");
const Next_camera_cctv45 = document.getElementById("Next_camera_cctv45");
const Back_camera_cctv45 = document.getElementById("Back_camera_cctv45");
const cctv_time = document.getElementById("cctv_clock");


const cctvcam28 = document.getElementById("cctvcam28");
const cctvcam37 = document.getElementById("cctvcam37");
const cctvcam45 = document.getElementById("cctvcam45");

boton2.addEventListener("click", function() {
    cctvcam15.style.display = "block";
    closecctv.style.display = "block";
    Next_camera_cctv15.style.display = "block";
    Back_camera_cctv15.style.display = "block";
    cctv_time.style.display = "block";
...
Back_camera_cctv15.addEventListener("click", function() {
    cctvcam15.style.display = "none";
    cctvcam45.style.display = "block";
    Next_camera_cctv15.style.display = "none";
    Back_camera_cctv15.style.display = "none";
    Next_camera_cctv45.style.display = "block";
    Back_camera_cctv45.style.display = "block";
});
Next_camera_cctv15.addEventListener("click", function() {
    cctvcam15.style.display = "none";

    cctvcam28.style.display = "block";

    Next_camera_cctv15.style.display = "none";
    Back_camera_cctv15.style.display = "none";

    Next_camera_cctv28.style.display = "block";
    Back_camera_cctv28.style.display = "block";
});


Back_camera_cctv28.addEventListener("click", function() {
    cctvcam15.style.display = "block";
    cctvcam28.style.display = "none";
    Next_camera_cctv15.style.display = "block";
    Back_camera_cctv15.style.display = "block";
    Next_camera_cctv28.style.display = "none";
    Back_camera_cctv28.style.display = "none";
});
Next_camera_cctv28.addEventListener("click", function() {
    cctvcam15.style.display = "none";
    cctvcam28.style.display = "none";
    cctvcam37.style.display = "block";
    Next_camera_cctv15.style.display = "none";
    Back_camera_cctv15.style.display = "none";
    Next_camera_cctv28.style.display = "none";
    Back_camera_cctv28.style.display = "none";
    Next_camera_cctv37.style.display = "block";
    Back_camera_cctv37.style.display = "block";
});


Back_camera_cctv37.addEventListener("click", function() {
    cctvcam28.style.display = "block";
    cctvcam37.style.display = "none";
    Next_camera_cctv28.style.display = "block";
    Back_camera_cctv28.style.display = "block";
    Next_camera_cctv37.style.display = "none";
    Back_camera_cctv37.style.display = "none";
});
Next_camera_cctv37.addEventListener("click", function() {
    cctvcam37.style.display = "none";
    cctvcam45.style.display = "block";
    Next_camera_cctv37.style.display = "none";
    Back_camera_cctv37.style.display = "none";
...
Back_camera_cctv45.addEventListener("click", function() {
    cctvcam45.style.display = "none";
    cctvcam37.style.display = "block";
    Next_camera_cctv45.style.display = "none";
    Back_camera_cctv45.style.display = "none";
    Next_camera_cctv37.style.display = "block";
    Back_camera_cctv37.style.display = "block";
});
Next_camera_cctv45.addEventListener("click", function() {
    cctvcam15.style.display = "block";
    cctvcam45.style.display = "none";
    Next_camera_cctv15.style.display = "block";
    Back_camera_cctv15.style.display = "block";
...
closecctv.addEventListener("click", function() {
    cctvcam15.style.display = "none";
    cctvcam28.style.display = "none";
    cctvcam37.style.display = "none";
    cctvcam45.style.display = "none";
    closecctv.style.display = "none";
    Next_camera_cctv15.style.display = "none";
    Back_camera_cctv15.style.display = "none";
    cctv_time.style.display = "none";
    Next_camera_cctv28.style.display = "none";
    Back_camera_cctv28.style.display = "none";
    Next_camera_cctv37.style.display = "none";
    Back_camera_cctv37.style.display = "none";
